...
class DataValidation:
    ...
    def get_train_and_test_df(self):
        try:
            train_df = pd.read_csv(self.data_ingstion_artifact.train_file_path)
            test_df = pd.read_csv(self.data_ingstion_artifact.test_file_path)
    ...
    def validate_dataset_schema(self)->bool:
        try:
            ...
            # train_dataframe_schema = build_table_schema(train_df)
            # test_dataframe_schema = build_table_schema(test_df)
